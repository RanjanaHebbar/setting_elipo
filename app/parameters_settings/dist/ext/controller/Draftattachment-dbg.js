        ...
        function _createUploadController(oExtensionAPI, Entity) {
            ...
            return {
                ...
                createfile: function () {
                    ...
                    var url = "https://elipo_backend-shy-echidna-yp.cfapps.us20.hana.ondemand.com/dev/company-logo";
                    var formData = new FormData();
                    formData.append("file", file_ori);
                    formData.append("file_name", "company_logo");
                    fetch(url, {
                        method: 'POST',
                        body: formData
                    })
        ...
        return {
            upload: function (oBindingContext, aSelectedContexts) {
                this.loadFragment({
                    ...
                    name: "parameterssettings.ext.fragment.Draftattachment",
